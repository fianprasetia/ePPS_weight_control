async function showModalInsertActivityType() {
    ...
    document.getElementById("load").innerHTML =
        "<a id='cancelBtn' onclick='closeModal()' class='btn  btn-danger'>" + kapital(cancel) + "</a> <a id='doneBtn' type='submit' onclick='InsertActivityType()' class='btn  btn-primary'>" + kapital(done) + "</a>";
}
async function InsertActivityType() {
   ...
   if (!token) {
    ...
    var url = mainUrl + "activitytype/insert";
