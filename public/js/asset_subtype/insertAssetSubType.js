async function showModalInsertAssetSubType(id) {
    ...
    document.getElementById("load").innerHTML =
        "<a id='cancelBtn' onclick='closeModal()' class='btn  btn-danger'>" + kapital(cancel) + "</a> <a id='doneBtn' type='submit' onclick='InsertAssetSubType()' class='btn  btn-primary'>" + kapital(done) + "</a>";
}
async function InsertAssetSubType() {
    let token = await JSON.parse(getCookie("dataToken"));
   if (!token) {
    ...
    $.extend(usefulLiteMenu, assetType, usernameMenu, languageMenu, { detail });
    dataAssetType.push(usefulLiteMenu);
    var xhr = new XMLHttpRequest();
    var url = mainUrl + "assetsubtype/insert";
