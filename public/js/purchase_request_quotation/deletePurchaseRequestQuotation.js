async function cancelTransaction() {
    ...
    document.getElementById("purchaseRequest").disabled = false
...
async function showModalDeletePurchaseRequestByCode(param) {
    var myModal = new bootstrap.Modal(document.getElementById("modalNotice"), { keyboard: false });
    myModal.toggle();
    document.getElementById("loadNotice").innerHTML = "<a id='cancelBtn' onclick='closeModal()' class='btn  btn-danger'>" + kapital(cancel) + "</a> <button id ='" + param + "' type='submit' onclick='deletePurchaseRequestQuotation(id)' class='btn  btn-primary'>" + kapital(done) + "</button>"
    document.getElementById("contentNotice").innerHTML = "<p>" + notice_delete + "</p>"
}

async function deletePurchaseRequestQuotation(id) {
   ...
   if (!token) {
    ...
    var url = mainUrl + "purchaserequestquotation/delete"
