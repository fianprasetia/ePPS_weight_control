async function selectContent() {
   ...
   if (!token) {
    ...
    async function dataContent(data) {
        ...
        menuDirectory = filterLanguage[0]["content"]["menu_mobile"]
        mainmenu = filterLanguage[0]["content"]["main_menu"]
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (response["access"] == "success") {
                ...
                for (j in responseData) {
                    captionlevel_1 = responseData[j]["adm_menu_mobile_translations"][0]["translation"]
                    ...
                    detailMenu += "\
                                                                    <li>"+ icon_1 + "<a href='#'  leveladd='2' id='" + idMenuLevel_1 + "' onclick='showModalUpdateMenu(id)'><span class='fw-light text-dark text-uppercase'>" + captionlevel_1 + "  (" + noOrdinal_1 + ")</span></a>\
                                                                        <ul>"
                    for (k in sublevel_1) {
                        captionlevel_2 = sublevel_1[k]["adm_menu_mobile_translations"][0]["translation"]
                        ...
                        detailMenu += "\
                                                                            ...
                                                                            <ul>"
                        for (l in sublevel_2) {
                            captionlevel_3 = sublevel_2[l]["adm_menu_mobile_translations"][0]["translation"]
                            ...
                            detailMenu += "\
                                                                                <li class='parent_li'>"+ icon_3 + "<a leveladd='3'  href='#'id='" + idMenuLevel_3 + "' onclick='showModalUpdateMenu(id)'><span class='fw-light text-dark text-uppercase'>" + captionlevel_3 + " (" + noOrdinal_3 + ")</span></a>\
                                                                                    <ul>"
                            for (m in sublevel_3) {
                                captionlevel_4 = sublevel_3[m]["adm_menu_mobile_translations"][0]["translation"]
