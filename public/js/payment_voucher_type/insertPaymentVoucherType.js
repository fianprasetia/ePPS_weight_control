async function showModalInsertVoucherType() {
    ...
    document.getElementById("load").innerHTML =
        "<a id='cancelBtn' onclick='closeModal()' class='btn  btn-danger'>" + kapital(cancel) + "</a> <a id='doneBtn' type='submit' onclick='insertVoucherType()' class='btn  btn-primary'>" + kapital(done) + "</a>";
}
async function insertVoucherType() {
   ...
   if (!token) {
    ...
    const codeVoucherType = document.getElementById("codeVoucherType").value;
    ...
    const codelActivityTypeMenu = JSON.parse('{"code_payment_voucher_type_POST":"' + codeVoucherType + '"}');
    $.extend(languageMenu, usernameMenu, codelActivityTypeMenu, { detail });
    dataActivityType.push(languageMenu);
    var xhr = new XMLHttpRequest();
    var url = mainUrl + "paymentvouchertype/insert";
