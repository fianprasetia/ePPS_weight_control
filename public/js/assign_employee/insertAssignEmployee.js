async function showModalInsertAssignEmployee() {
  ...
  await selectMondayHours()
  await selectTuesdayHours()
  await selectWednesdayHours()
  await selectThursdayHours()
  await selectFridayHours()
  await selectSaturdayHours()
  await selectSundayHours()
  document.getElementById("load").innerHTML = "<a id='cancelBtn' onclick='closeModal()' class='btn  btn-danger'>" + kapital(cancel) + "</a> <button id='doneBtn' type='submit' onclick='InsertAssignEmployee()()' class='btn  btn-primary'>" + kapital(done) + "</button>"
}
async function InsertAssignEmployee() {
  ...
  var url = mainUrl + "employeeassign/insert";
