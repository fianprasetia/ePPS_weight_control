async function showModalInsertAssetType(id) {
    await selectLanguage();
    await selectCOADepreciation()
    await selectCOAFixedAsset()
    ...
    document.getElementById("load").innerHTML =
        "<a id='cancelBtn' onclick='closeModal()' class='btn  btn-danger'>" + kapital(cancel) + "</a> <a id='doneBtn' type='submit' onclick='InsertAssetType()' class='btn  btn-primary'>" + kapital(done) + "</a>";
}
async function InsertAssetType() {
   ...
   if (!token) {
    ...
    $.extend(accumulatedMenu, depreciationMenu, codelMenu, usernameMenu, languageMenu, { detail });
    dataAssetType.push(accumulatedMenu);
    var xhr = new XMLHttpRequest();
    var url = mainUrl + "assettype/insert";
