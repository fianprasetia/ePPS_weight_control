async function showModalInsertReceivingLocations() {
  ...
  document.getElementById("load").innerHTML =
    ...
    cancel +
    "</a> <a id='doneBtn' type='submit' onclick='insertReceivingLocations()' class='btn  btn-primary'>" +
    done +
    "</a>";
...
async function insertReceivingLocations() {
  ...
  var url = mainUrl + "receivinglocations/insert";
