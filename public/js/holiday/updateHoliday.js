async function showUpdateHoliday(code) {
    ...
    xhr.onloadend = async function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (response["access"] == "success") {
                ...
                document.getElementById("periodDateHeader").value = responseData[0]["period"]
                document.getElementById("load").innerHTML = "<a id='doneBtn' type='submit' onclick='updateHoliday()' class='btn  btn-primary'>" + kapital(process) + "</a>"
...
async function updateHoliday() {
   ...
   if (!token) {
    ...
    var xhr = new XMLHttpRequest();
    var url = mainUrl + "holiday/update";
