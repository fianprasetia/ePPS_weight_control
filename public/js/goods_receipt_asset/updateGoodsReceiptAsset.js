async function updateCheckGoodsReceipt(id) {
   ...
   if (!token) {
    ...
    var url = mainUrl + "goodsreceiptasset/bycode"
...
async function updateGoodsReceipt(id) {
    ...
    const codeWarehouseOrder = document.getElementById("codeWH").value
   ...
   if (!token) {
    ...
    var xhr = new XMLHttpRequest();
    var url = mainUrl + "goodsreceiptasset/update";
...
async function updatePostingGoodsReceipt(id) {
   ...
   if (!token) {
    ...
    var xhr = new XMLHttpRequest();
    var url = mainUrl + "goodsreceiptasset/posting"
    xhr.onloadstart = function () {
