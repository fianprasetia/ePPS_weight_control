...
const log_goods_issue_approval = koneksi.define(
    "log_goods_issue_approval",
    {
        code_goods_issue: {
...
log_goods_issue_approval.belongsTo(hrd_employee, { foreignKey: "employee_id" });
// log_goods_receipt_approval.hasOne(log_goods_receipt, { foreignKey: "code_goods_receipt" });
module.exports = log_goods_issue_approval;